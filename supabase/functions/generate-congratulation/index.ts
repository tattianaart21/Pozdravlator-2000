...
const TONE_INSTRUCTIONS: Record<string, string> = {
  ...
  kuruch: 'В стиле Ильи Куруча: отменные, харизматичные поздравления — уверенные, запоминающиеся, с огоньком. Живой язык, тёплый юмор без перебора, обращение по имени так, чтобы человек почувствовал, что его ценят. Никакого официоза и казёнщины.',
};
